...
class RegistrationRequestTest {
    ...
    void validRequest_ShouldPassValidation(Validator validator) {
        var request = new RegistrationRequest("Peter", "peter@bethsaida.il", "OnThisRock!1");
    ...
    void blankName_ShouldFailValidation(Validator validator) {
        var request = new RegistrationRequest("   ", "andrew@bethsaida.il", "FisherOfMen!1");
    ...
    void blankEmail_ShouldFailValidation(Validator validator) {
        var request = new RegistrationRequest("John", "   ", "Revelation!1");
    ...
    void invalidEmailFormat_ShouldFailValidation(Validator validator) {
        var request = new RegistrationRequest("Thomas", "invalid-email", "NoWay!123");
    ...
    void weakPassword_ShouldFailValidation(Validator validator) {
        var request = new RegistrationRequest("James", "james@bethsaida.il", "lowercase!");
    ...
    void shouldDeserializeCorrectly(JacksonTester<RegistrationRequest> tester) throws IOException {
        ...
        assertThat(request.password()).isEqualTo("Silver!30");
    }
}
