...
@ApiContractTest
class UpdateActivationRequestTest {
    ...
    @Test
    void nonRecurring_ShouldSerializeCorrectlyAndIgnoreValidationMethods(JacksonTester<UpdateActivationRequest> tester) throws IOException {
        var request = new UpdateActivationRequest(
    ...
    @Test
    void recurring_shouldSerializeCorrectlyAndIgnoreValidationMethods(JacksonTester<UpdateActivationRequest> tester) throws IOException {
        var request = new UpdateActivationRequest(
    ...
    @Test
    void nonRecurring_shouldDeserializeCorrectly(JacksonTester<UpdateActivationRequest> tester) throws IOException {
        var payload = """
                {
                    "applianceId": 1,
                    "houseId": 3,
    ...
    @Test
    void recurring_shouldDeserializeCorrectly(JacksonTester<UpdateActivationRequest> tester) throws IOException {
        var payload = """
                {
                    "applianceId": 2,
                    "houseId": 3,
