...
public class SwitchableMetricRepository implements MetricRepository {
    ...
    @Override
    public Metric add(Metric metric) { return getActiveRepo().add(metric); }

    @Override
    public Metric get(Long houseId, Long metricId) { return getActiveRepo().get(houseId, metricId); }

    @Override
    public List<Metric> getAll(Long houseId) { return getActiveRepo().getAll(houseId); }
