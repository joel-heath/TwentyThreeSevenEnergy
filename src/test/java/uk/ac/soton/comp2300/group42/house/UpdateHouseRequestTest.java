...
class UpdateHouseRequestTest {
    ...
    @Test
    void shouldSerializeCorrectly(JacksonTester<UpdateHouseRequest> tester) throws IOException {
        var request = new UpdateHouseRequest(
                "Primary House",
                "123 Main St",
                ZoneId.of("Europe/London")
    ...
    @Test
    void shouldDeserializeCorrectly(JacksonTester<UpdateHouseRequest> tester) throws IOException {
        var payload = """
                {
                    "name": "Primary House",
                    "address": "123 Main St",
