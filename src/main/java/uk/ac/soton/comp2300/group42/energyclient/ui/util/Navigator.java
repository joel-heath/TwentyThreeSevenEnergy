...
public class Navigator {
    ...
    public static <T> void initializeAbsolute(String fxmlPath, Stage mainStage, Consumer<T> controllerSetup) throws IOException {
        ...
        rootScene.getStylesheets().add(Objects.requireNonNull(Navigator.class.getResource("/uk/ac/soton/comp2300/group42/energyclient/ui/styles/global.css")).toExternalForm());
